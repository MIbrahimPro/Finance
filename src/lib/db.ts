...
import type { Transaction, Tag, Person, PersonEntry, StatsEntry, DashboardLayout, StatsLayout, SyncQueueItem, Setting } from './types';
...
const db = new Dexie('FinanceDB') as Dexie & {
  ...
  statsEntries: EntityTable<StatsEntry, 'id'>;
...
db.version(3).stores({
  ...
  statsEntries: 'id, userId, section, updatedAt',
